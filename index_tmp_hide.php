...
$result_url = 'http://' . $_SERVER['HTTP_HOST'] . '/result-{qid}-' .$v. '-index.html';
$result_url = str_replace ( '{qid}', $qid, $result_url );
$current_domain = $_SERVER['HTTP_HOST'];

//分享链接
$short_domain = strtolower(get_rand_str(3,3)).'.'.$result_domain;
$share_freind_url = 'http://'.$short_domain."/"; // 分享微信好友
$share_timeline_url = 'http://'.$short_domain."/"; // 分享朋友圈
?>
<!DOCTYPE html>
<html>
<script>
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?71a4e2158ab1dceb3348113b3cb66f2f";
  var s = document.getElementsByTagName("script")[0]; 
  s.parentNode.insertBefore(hm, s);
})();
</script>
<head>
<title>抽取你的<?php echo emoji();?>下半生运势签！</title>
<meta name="keywords" content="下半生,运势，抽签" />
<meta name="description" content="查询下半生运势，快来抽取你的下半生运势签吧！" />
...
<body
	style="background: url(/images/nextlife/0.jpg) no-repeat center center/cover #E8DFD0;"
	onload="init()">
	...
	function share_ajax(val){
		...
		wx.ready(function(){
		    ...
		    var  share_title = "抽取你的<?php echo emoji();?>下半生运势签！";		
		    var share_desc = "查询下半生运势，快来抽取你的下半生运势签吧！";
			var share_friend_link = "<?php echo $share_freind_url;?>";
			var share_timeline_link = "<?php echo $share_timeline_url;?>";			
			var share_img_url = "http://<?php echo $current_domain;?>/images/nextlife/0.jpg";					
