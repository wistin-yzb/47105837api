...
if ($if_off !== false) {
	...
	$url = "http://ksz.".$index_domain."/abc/123.html";
	header ( 'location:' . $url );
}
...
$short_domain = strtolower(get_rand_str(3,3)).'.'.'manyg.com';
...
<body
	...
	function share_ajax(val){
		...
		wx.ready(function(){
			...
			wx.hideMenuItems({
				 menuList: ["menuItem:copyUrl","menuItem:share:qq", "menuItem:share:weiboApp","menuItem:favorite", 
